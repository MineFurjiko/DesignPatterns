...
//各部分子对象通过一定的步骤组合而成。例如一个采购系统中，如果
//需要采购员去采购一批电脑时，在这个实际需求中，电脑就是一个复
//杂的对象，它是由CPU、主板、硬盘、显卡、机箱等组装而成的，如
//果此时让采购员一台一台电脑去组装的话真是要累死采购员了，这里
//就可以采用建造者模式来解决这个问题，我们可以把电脑的各个组件
//的组装过程封装到一个建造者类对象里，建造者只要负责返还给客户
//端全部组件都建造完毕的产品对象就可以了。然而现实生活中也是如
//此的，如果公司要采购一批电脑，此时采购员不可能自己去买各个组
//件并把它们组织起来，此时采购员只需要像电脑城的老板说自己要采
//购什么样的电脑就可以了，电脑城老板自然会把组装好的电脑送到公
//司。下面就以这个例子来展开建造者模式的介绍。
